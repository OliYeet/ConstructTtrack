      ...
      <div className="max-w-7xl mx-auto">
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-sm font-medium text-gray-500">Unique Errors</h3>
              <p className="text-2xl font-bold text-gray-900">{stats.uniqueErrors}</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {stats.totalReports > 0 ? 
                  ((stats.recentErrors / stats.totalReports) * 100).toFixed(1) : 0}%
              </p>
            </div>
          </div>
        )}
        ...
        <div className="bg-white shadow rounded-lg">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {errors.map((error) => (
                  <tr key={error.fingerprint} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getTypeColor(error.classification.type)}`}>
                        {error.classification.type}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getSeverityColor(error.classification.severity)}`}>
          ...
          {errors.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500">No errors found for the selected timeframe.</p>
            </div>
          )}
        </div>
      </div>
