...
**User Story**: As a project manager, I want to track equipment allocation so that I can ensure
...
**User Story**: As a project manager, I want to manage drawing revisions so that the team always
