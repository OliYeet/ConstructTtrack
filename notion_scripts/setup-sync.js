...
async function setupSync() {
    ...
    if (!existsSync('.env')) {
        ...
        if (existsSync('.env.example')) {
            ...
            console.log(chalk.yellow('📝 Please edit .env file with your Notion credentials\n'));
        } else {
    ...
    console.log(chalk.gray('   - Add webhook URL: http://localhost:3001/webhook'));
    console.log(chalk.gray('   - Subscribe to: page.updated, page.created, page.deleted'));
    
    console.log(chalk.white('\n4. Test the sync:'));
    console.log(chalk.gray('   - Make changes in Notion → Local files update automatically'));
    ...
    console.log(chalk.blue('\n📁 Generated Files:'));
    console.log(chalk.gray('- docs/constructtrack_agile_project_plan.md (synced)'));
    ...
    console.log(chalk.yellow('\n💡 Pro Tips:'));
    console.log(chalk.gray('- Use ngrok for public webhook URL during development'));
