...
function displaySetupInstructions() {
    ...
    console.log(chalk.gray('   • Copy the Integration Token (starts with "secret_")'));
    ...
    console.log(chalk.gray('   • Edit the .env file with your actual credentials'));
    console.log(chalk.gray('   • Replace NOTION_TOKEN with your integration token'));
    console.log(chalk.gray('   • Replace NOTION_PARENT_PAGE_ID with your page ID'));
    ...
    console.log(chalk.gray('   • Notion Integrations: https://www.notion.so/my-integrations'));
    console.log(chalk.gray('   • Notion API Docs: https://developers.notion.com/'));
}
...
function checkPrerequisites() {
    ...
    if (!existsSync(markdownFile)) {
        ...
        console.log(chalk.yellow('   Please ensure the agile project plan file exists'));
        return false;
    } else {
    ...
    if (majorVersion < 16) {
        console.log(chalk.red(`❌ Node.js ${nodeVersion} detected. Node.js 16+ required.`));
...
async function main() {
    ...
    console.log(chalk.yellow('📝 Next: Edit the .env file with your Notion credentials'));
