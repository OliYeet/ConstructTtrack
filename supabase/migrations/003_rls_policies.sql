...
-- Equipment: Only admins and managers can create/update/delete
...
-- Materials: Only admins and managers can create/update/delete
...
-- Forms: Only admins and managers can create forms
